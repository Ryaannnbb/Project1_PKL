...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info " href="teacher_data.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb"> 
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Teacher Data</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Teacher Data</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
              <h6 class="text-white text-capitalize ps-3 mb-0">Teacher Data</h6>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php
                    $id = 1;
                    $tampil = mysqli_query($koneksi, "SELECT * FROM tb_guru ORDER BY id");
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../crud/create_teacher_data.php" role="form">
                    ...
                    <div class="modal fade" id="ModalUbah<?= $id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../crud/edit_teacher_data.php" role="form">
                                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                        <div class="input-group input-group-outline mb-3">
                                            <input placeholder="Enter Teacher Name" type="text" class="form-control" name="nama_guru" value="<?= $data['nama_guru'] ?>">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-dark" data-bs-dismiss="modal" onclick="resetForm()">Cancel</button>
                    ...
                    <div class="modal fade" id="ModalHapus<?= $id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="../crud/delete_teacher_data.php" role="form">
                                        <input type="hidden" name="id" value="<?= $data['id'] ?>">
  ...
  function validateForm() {
    var namaGuru = document.querySelector('input[name="nama_guru"]').value;
  ...
  function resetForm() {
    document.querySelector('input[name="nama_guru"]').value = '';
  }
