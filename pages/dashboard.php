      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="subjects_mapel_data.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa-solid fa-book fa-lg"></i>            </div>
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-body px-0 pb-2">
              ...
              <div class="bg-gradient-transparent d-flex align-items-center">
                <img src="../assets/img/illustrations/Welcome-cuate.svg " alt="" width="450" />
                <div class="ml-4">
                  <h1 class="text-center" >Welcome To Page</h1>
                  <p class="ini text-center">This is an interesting page.</p>
                </div>
              </div>  
              </div>
            </div>
